...
public class Login extends JFrame {
	...
	private void login() {
		...
		if (verificarUsu(usuario, contraseña)) {
	...
	private boolean verificarUsu(String usuario, String contraseña) {
		usuarioController = new UsuarioController();
		var usuarios = usuarioController.listar();

		for (var usu : usuarios) {
			if(usuario.equals(usu.getUsuario()) && contraseña.equals(usu.getContraseña())) {
				return true;
			}
		}
		return false;
