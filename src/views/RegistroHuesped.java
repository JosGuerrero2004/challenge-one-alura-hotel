...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		lblTitulo.setBounds(591, 48, 242, 42);
	...
	private void guardar() {
		Date fechaNa = new Date(txtFechaN.getDate().getTime());

		Huespedes huesped = new Huespedes(txtNombre.getText(), txtApellido.getText(), fechaNa,
